...
double IK::targetCost() {
	...
	Vec3d headConstraint = Model::m_modelList[HEADCONSTRAINT]->getOrigin();
	...
	Vec3d leftHandConstraint = Model::m_modelList[LHANDCONSTRAINT]->getOrigin();
	...
	Vec3d rightHandConstraint = Model::m_modelList[RHANDCONSTRAINT]->getOrigin();
	...
	Vec3d leftFootConstraint = Model::m_modelList[LFOOTCONSTRAINT]->getOrigin();
	...
	Vec3d rightFootConstraint = Model::m_modelList[RFOOTCONSTRAINT]->getOrigin();
